...
public class controller_frais_scolaire {
    ...
    @Autowired
    private service_frais_scolaire fraisScolaireService;
    ...
    @GetMapping("/{id}")
    public ResponseEntity<?> getFraisScolaireById(@PathVariable Long id) {
    ...
    public ResponseEntity<List<dto_frais_scolaire.Response>> getFraisScolairesByEnfant(@PathVariable Long enfantId) {
        List<dto_frais_scolaire.Response> frais = fraisScolaireService.getFraisScolairesByEnfant(enfantId);
        return ResponseEntity.ok(frais);
    }

    @PutMapping("/{id}")
    public ResponseEntity<?> updateFraisScolaire(@PathVariable Long id, @RequestBody dto_frais_scolaire.UpdateRequest request) {
        try {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteFraisScolaire(@PathVariable Long id) {
        try {
