...
public class controller_recu_depense {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<dto_recu_depense.Response> getRecuById(@PathVariable Long id) {
    ...
    public ResponseEntity<List<dto_recu_depense.Response>> getRecusByAssociation(@PathVariable Long associationId) {
    ...
    public ResponseEntity<List<dto_recu_depense.Response>> getRecusByDepense(@PathVariable Long depenseId) {
    ...
    // Modifier un reçu
    @PutMapping("/{id}")
    public ResponseEntity<?> updateRecu(@PathVariable Long id, @RequestBody dto_recu_depense.UpdateRequest request) {
        try {
