...
public class controller_parrainage_depense {
    ...
    public ResponseEntity<List<dto_parrainage_depense.Response>> getPrisesEnChargeByParrainage(@PathVariable int parrainageId) {
    ...
    public ResponseEntity<List<dto_parrainage_depense.Response>> getPrisesEnChargeByEnfant(@PathVariable int enfantId) {
    ...
    public ResponseEntity<List<dto_parrainage_depense.Response>> getPrisesEnChargeByDepense(@PathVariable int depenseId) {
    ...
    public ResponseEntity<dto_parrainage_depense.ResumeDepenseResponse> getResumeDepense(@PathVariable int depenseId) {
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<dto_parrainage_depense.Response> modifierPriseEnCharge(@PathVariable int id, @RequestBody dto_parrainage_depense.UpdateRequest request) {
        try {
    ...
    public ResponseEntity<dto_parrainage_depense.Response> confirmerPriseEnCharge(@PathVariable int id) {
        try {
    ...
    public ResponseEntity<dto_parrainage_depense.Response> refuserPriseEnCharge(@PathVariable int id) {
        try {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> supprimerPriseEnCharge(@PathVariable int id) {
        try {
