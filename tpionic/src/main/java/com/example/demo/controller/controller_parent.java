...
public class controller_parent {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<dto_parent.Response> getParentById(@PathVariable Long id) {
    ...
    // Modifier un parent
    @PutMapping("/{id}")
    public ResponseEntity<dto_parent.Response> updateParent(@PathVariable Long id, @RequestBody dto_parent.UpdateProfilRequest request) {
        try {
