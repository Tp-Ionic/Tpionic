...
public class controller_association {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<dto_association.Response> getAssociationById(@PathVariable int id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<dto_association.Response> updateAssociation(@PathVariable int id, @RequestBody dto_association.UpdateRequest request) {
        try {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteAssociation(@PathVariable int id) {
        try {
    ...
    public ResponseEntity<dto_enfant.Response> addEnfant(@PathVariable  int associationId, @RequestBody dto_enfant.CreateRequest request) {
        try {
    ...
    public ResponseEntity<String> uploadBulletin(@PathVariable int associationId,
    ...
    public ResponseEntity<String> uploadPhotoActivite(@PathVariable int associationId,
                                                      @PathVariable int enfantId,
                                                      @RequestParam("file") MultipartFile file) {
        try {
