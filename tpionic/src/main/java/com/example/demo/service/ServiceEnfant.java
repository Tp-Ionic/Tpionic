...
public class ServiceEnfant {
        ...
        public ServiceEnfant(EnfantRepository enfantRepository,AssociationRepository associationRepository,ParentRepository parentRepository) {
        ...
        public List<dto_enfant.Response> getEnfantsByAssociation(int associationId) {
        ...
        public Optional<dto_enfant.Response> getEnfantById(int id) {
            return enfantRepository.findById(id)
                    .map(dto_enfant::of);
        }

        public dto_enfant.Response updateEnfant(int id, dto_enfant.UpdateRequest request) {
