...
@Service
public class ServiceFraisScolaire {

    private FraisScolaireRepository fraisScolaireRepository;
    private EnfantRepository enfantRepository;
    public ServiceFraisScolaire(FraisScolaireRepository fraisScolaireRepository,EnfantRepository enfantRepository){
    ...
    public Optional<dto_frais_scolaire.Response> getFraisScolaireById(int id) {
        return fraisScolaireRepository.findById(id)
                .map(dto_frais_scolaire::of);
    }

    public List<dto_frais_scolaire.Response> getFraisScolairesByEnfant(int enfantId) {
    ...
    public dto_frais_scolaire.Response updateFraisScolaire(int id, dto_frais_scolaire.UpdateRequest request) {
