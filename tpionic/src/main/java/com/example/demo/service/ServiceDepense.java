...
public class ServiceDepense {
    ...
    public Optional<dto_depense.Response> getDepenseById(int id) {
        return depenseRepository.findById(id)
                .map(dto_depense::of);
    }

    public dto_depense.Response updateDepense(int id, dto_depense.UpdateRequest request) {
    ...
    public List<dto_depense.Response> getDepensesByPaiement(int paiementId) {
    ...
    public List<dto_depense.Response> getDepensesByEnfant(int enfantId) {
    ...
    public List<dto_depense.Response> getDepensesByAssociation(int associationId) {
