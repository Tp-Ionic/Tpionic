...
public class service_rapport_scolaire {
    ...
    public Optional<dto_rapport_scolaire.Response> getRapportById(Long id) {
        return rapportRepository.findById(id)
                .map(dto_rapport_scolaire::of);
    }

    // Obtenir les rapports d'un enfant
    public List<dto_rapport_scolaire.Response> getRapportsByEnfant(Long enfantId, String anneeScolaire) {
    ...
    // Modifier un rapport
    public dto_rapport_scolaire.Response updateRapport(Long id, dto_rapport_scolaire.UpdateRequest request) {
