...
public class dto_parrainage {
    ...
    public static class CreateRequest {
        ...
        public int enfantId;         // Obligatoire - enfant à parrainer
        public int associationId;    // Obligatoire - association qui fait la demande
    ...
    public static class Response {
        public int id;
        public int parrainId;     // Changé de Long à Integer
