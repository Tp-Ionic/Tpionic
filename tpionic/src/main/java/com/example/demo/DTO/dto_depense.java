...
public class dto_depense {
    ...
    public static class CreateRequest {
        ...
        public String notes;
        public Long paiementId;        // Optionnel - pour lier à un paiement spécifique
        public Long enfantId;          // Obligatoire - enfant concerné
        public Long associationId;      // Obligatoire - association qui fait la dépense
    }
